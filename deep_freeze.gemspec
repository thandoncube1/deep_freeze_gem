...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{TODO:  This gem allows the user securely protect objects in their project by stopping the mutation of frozen arrays and hashes. This is good when trying to have clearly defined structres in an application to reduce buggy code.}
  spec.description   = %q{TODO: What does it mean for an object to be mutable?
